...
export const projectilePracticeBlocks: ReactElement[] = [
    ...
    <StackLayout key="layout-practice-question-time" maxWidth="xl">
        <Block id="practice-question-time" padding="sm">
            <EditableParagraph id="para-practice-question-time" blockId="practice-question-time">
                Gravity takes 10 m/s off the climb every second, so the ball stops rising after{" "}
                <InlineFeedback
                    varName="answerPracticeClimbTime"
                    correctValue={["2", "2 s", "2s"]}
                    position="mid"
                    hint="How many bites of 10 m/s fit into 20 m/s"
                ...
                >
                    <InlineClozeInput
                        ...
                        {...clozePropsFromDefinition(getVariableInfo('answerPracticeClimbTime'))}
                    />
                </InlineFeedback>{" "}
                seconds, and the whole flight therefore lasts{" "}
                <InlineFeedback
                    varName="answerPracticeFlightTime"
                    correctValue={["4", "4 s", "4s"]}
                    position="terminal"
                    successMessage="— spot on, the fall mirrors the climb exactly, so the two halves take the same time"
                    failureMessage="— not yet."
                    hint="Coming down takes just as long as going up"
                    reviewBlockId="flight-insight"
                    reviewLabel="Revisit the climb"
                >
                    <InlineClozeInput
                        ...
                        {...clozePropsFromDefinition(getVariableInfo('answerPracticeFlightTime'))}
                    />
                </InlineFeedback>{" "}
                seconds.
            </EditableParagraph>
